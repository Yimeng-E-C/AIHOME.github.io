        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">学术前沿</h3>
              <p className="text-gray-600">追踪最新AI研究动态</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">商业应用</h3>
              <p className="text-gray-600">发现AI的商业价值</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">快捷工具</h3>
              <p className="text-gray-600">直达各大AI平台</p>
            </div>
          </div>
        </div>
      </div>
